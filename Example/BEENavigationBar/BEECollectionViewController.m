...
@interface BEECollectionViewController ()

@end

@implementation BEECollectionViewController
...
- (void)viewDidLoad {
    ...
    self.navigation_item.title = @"UICollectionViewController";
